...
namespace rogue::platform
{
	...
	AppPaths BuildAppPaths(PathEnvironment const& environment)
	{
		...
		case HostPlatform::Windows:
			paths.dataDirectory = environment.roamingAppData / "Pokabbie" / "Rogue Assistant";
		...
		case HostPlatform::MacOS:
			paths.dataDirectory = environment.homeDirectory / "Library" / "Application Support" / "Pokabbie"
				/ "Rogue Assistant";
			paths.configDirectory = paths.dataDirectory;
			break;
